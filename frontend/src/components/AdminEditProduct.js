...
const AdminEditProduct = ({ onClose, productData, fetchdata }) => {
  ...
  return (
    <div className="fixed w-full h-full bg-slate-200 bg-opacity-35 bottom-0 top-0 right-0 left-0 flex justify-center items-center">
      <div className="bg-white p-4 rounded w-full max-w-2xl h-full max-h-[82%] overflow-hidden">
